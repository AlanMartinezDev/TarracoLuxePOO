<fieldset>
    ...
    <input type="text" id="titulo" name="titulo" value="<?php echo s($propiedad->titulo); ?>" placeholder="Título de la propiedad">
...
<fieldset>
    ...
    <input type="number" id="habitaciones" name="habitaciones" value="<?php echo s($propiedad->habitaciones); ?>" placeholder="Número de habitaciones" min="1" max="9">
    <label for="wc">Baños:</label>
    <input type="number" id="wc" name="wc" value="<?php echo s($propiedad->wc); ?>" placeholder="Número de baños" min="1" max="9">
    <label for="plazas">Plazas:</label>
    <input type="number" id="plazas" name="plazas" value="<?php echo s($propiedad->plazas); ?>" placeholder="Número de plazas" min="1" max="9">
</fieldset>
<fieldset>
